...
export function getMaskedContext(workInProgress: Fiber, unmaskedContext: Object) {
...
export function pushTopLevelContextObject(fiber: Fiber, context: Object, didChange: boolean): void {
  invariant(
...
export function processChildContext(fiber: Fiber, parentContext: Object): Object {
...
export function invalidateContextProvider(workInProgress: Fiber, didChange: boolean): void {
  const instance = workInProgress.stateNode;
  invariant(
    instance,
