...
type MutableUpdatesHostConfig<T, P, I, TI, C, PL> = {
  ...
  insertInContainerBefore(container: C, child: I | TI, beforeChild: I | TI): void,
...
type HydrationHostConfig<T, P, I, TI, HI, C, CX, PL> = {
  ...
  didNotHydrateInstance(parentType: T, parentProps: P, parentInstance: I, instance: I | TI): void,
  didNotFindHydratableContainerInstance(parentContainer: C, type: T, props: P): void,
  didNotFindHydratableContainerTextInstance(parentContainer: C, text: string): void,
...
export type Reconciler<C, I, TI> = {
  createContainer(containerInfo: C, isAsync: boolean, hydrate: boolean): OpaqueRoot,
  updateContainer(
  ...
  getPublicRootInstance(container: OpaqueRoot): React$Component<any, any> | TI | I | null,
...
export default function<T, P, I, TI, HI, PI, C, CC, CX, PL>(
  ...
  return {
    ...
    getPublicRootInstance(container: OpaqueRoot): React$Component<any, any> | PI | null {
